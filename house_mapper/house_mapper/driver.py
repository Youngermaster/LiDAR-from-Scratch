"""
driver.py - a minimal, from-scratch driver for the RPLIDAR C1.

Vendored copy of python/lib/rplidar_c1.py so this subproject is
self-contained. The two files should stay in sync; if you fix a bug
